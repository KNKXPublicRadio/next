...
```
* * * * * ubuntu bash /home/ubuntu/apps/next/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|next|tweet|`location`||
|next|facebook|`location`||
|next|email|`location`||
|next|new-comment||
|next|open-share-discuss||
|next|close-share-discuss||
|next|summary-copied||
|next|featured-tweet-action|`action`|
|next|featured-facebook-action|`action`|
